...
| `--prefer` or `--constraint` | | Prefer or require specific [node features](partitions.md#node-features), respectively. [Details here](https://slurm.schedmd.com/archive/slurm-24.11.4/sbatch.html#OPT_prefer)  |
